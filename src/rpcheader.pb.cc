...
static void InitDefaultsscc_info_RpcHeader_rpcheader_2eproto() {
  ...
  {
    void* ptr = &::mprpcHeader::_RpcHeader_default_instance_;
    new (ptr) ::mprpcHeader::RpcHeader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mprpcHeader::RpcHeader::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpcHeader::RpcHeader, servicename_),
  PROTOBUF_FIELD_OFFSET(::mprpcHeader::RpcHeader, methodname_),
  PROTOBUF_FIELD_OFFSET(::mprpcHeader::RpcHeader, argssize_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::mprpcHeader::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::mprpcHeader::_RpcHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\013mprpcHeader\"F\n\tRpcHea"
...
RpcHeader::RpcHeader()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mprpcHeader.RpcHeader)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:mprpcHeader.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mprpcHeader.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mprpcHeader.RpcHeader)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:mprpcHeader.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::mprpcHeader::RpcHeader* Arena::CreateMaybeMessage< ::mprpcHeader::RpcHeader >(Arena* arena) {
  return Arena::CreateInternal< ::mprpcHeader::RpcHeader >(arena);
}
